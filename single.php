        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="news-img-box">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slide-3.jpg" alt="" class="img-fluid">
            </div>
          </div>
              ...
              <ul class="list-comments">
                <li>
                  <div class="comment-avatar">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/author-2.jpg" alt="">
                  </div>
